...
- [x] AI Code Health Audit — per-analysis Health Audit tab with SVG score rings (Security / Maintainability / Architecture, 0–100) and prioritized `FindingCard` list (severity-bordered, file-linked, with concrete recommendations); generated by Gemini from actual code read during analysis
